...
abstract class Model extends Fn_base {
	...
	public function __construct() {		
		...
		$slave_params		= Controller::load_config('database.slave');
		if (!is_array($params)) Controller::halt('Contents of the file: config.inc.php is not correct! It must be an array.');
		//存在从库就调用mysql_slave类
