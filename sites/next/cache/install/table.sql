...
(6, 1, 2, 3, '', 0, '', 0, 0, '文字块管理', 'admin/block/index', '', '', '', '', 0),

(7, 1, 2, 0, '', 1, '', 1, 0, '系统设置', '#', '#', 'fa-cogs', '#', '系统设置', 3),
(8, 1, 2, 7, '', 0, '', 1, 0, '后台菜单', 'admin/menu/index', '', '', '', '', 0),
(9, 1, 2, 7, '', 0, '', 1, 0, '系统相关', 'admin/index/config', '&amp;type=1', '', '', '', 0),
(10, 1, 2, 7, '', 0, '', 0, 0, '邮件设置', 'admin/index/config', '&amp;type=2', '', '', '', 0),
(11, 1, 2, 7, '', 0, '', 0, 0, '网站地图', 'admin/index/config', '&amp;type=3', '', '', '', 0),
(12, 1, 2, 7, '', 0, '', 0, 0, '搜索设置', 'admin/index/config', '&amp;type=4', '', '', '', 0),
(13, 1, 2, 7, '', 0, '', 0, 0, 'TAG相关', 'admin/index/config', '&amp;type=5', '', '', '', 0),
(14, 1, 2, 7, '', 0, '', 1, 0, '操作日志', 'admin/index/log', '', '', '', '', 0),
(15, 1, 2, 7, '', 0, '', 1, 0, '攻击日志', 'admin/index/attack', '', '', '', '', 0),
(16, 1, 2, 7, '', 0, '', 1, 0, '禁止访问', 'admin/ip/index', '', '', '', '', 0),

(17, 1, 2, 0, '', 1, '', 1, 0, '网站管理', '#', '#', 'fa-sitemap', '#', '', 4),
(18, 1, 2, 17, '', 0, '', 1, 0, '网站配置', 'admin/site/config', '', '', '', '', 0),
(19, 1, 2, 17, '', 0, '', 0, 0, '多网站管理', 'admin/site/index', '', '', '', '', 0),
(20, 1, 2, 17, '', 1, '', 1, 0, '添加管理员', 'admin/user/add', '', '', '', '', 0),
(21, 1, 2, 17, '', 1, '', 1, 0, '管理员管理', 'admin/user/index', '', '', '', '', 0),
(22, 1, 2, 17, '', 0, '', 0, 0, '角色权限管理', 'admin/auth/index', '', '', '', '', 0),
(23, 1, 2, 17, '', 0, '', 0, 0, '更新权限缓存', 'admin/auth/cache', '', '', '', '', 0),
(24, 1, 2, 17, '', 0, '', 0, 0, '更新SiteMap', 'admin/index/updatemap', '', '', '', '', 0),

(25, 1, 2, 0, '', 1, '', 0, 0, '模板管理', '#', '#', 'fa-file-code-o', '#', '', 5),
(26, 1, 2, 25, '', 0, '', 1, 0, '网站模板', 'admin/theme/index', '', '', '', '', 0),
(27, 1, 2, 25, '', 0, '', 1, 0, '标签向导', 'admin/theme/demo', '', '', '', '', 0),
(28, 1, 2, 25, '', 0, '', 1, 0, '更新缓存', 'admin/theme/cache', '', '', '', '', 0);