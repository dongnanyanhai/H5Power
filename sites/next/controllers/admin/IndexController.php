...
class IndexController extends Admin {
	...
	public function configAction() {
	    ...
	    $string = array(
			...
			'SITE_FNX_WXAPPSECRET'    => lang('a-fnx-51'),

			'SITE_FNX_WXPAYID'        => lang('a-fnx-75'),
			'SITE_FNX_WXPAYSECRET'    => lang('a-fnx-76'),
			'SITE_FNX_WXPAYCERTPATH'  => lang('a-fnx-77'),
        );
	    //加载应用程序配置文件.
	...
	public function logAction() {
		...
		$pagelist->loadconfig();
	    $logsdir  = SITE_ROOT . 'cache' . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR;
	...
	public function attackAction() {
	    ...
	    $pagelist = $this->instance('pagelist');
		$pagelist->loadconfig();
	    $logsdir  = SITE_ROOT . 'cache' . DIRECTORY_SEPARATOR . 'attack' . DIRECTORY_SEPARATOR;
		$filedata = file_list::get_file_list($logsdir);
		$data     = array();
