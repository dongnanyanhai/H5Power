	...
	public function indexAction() {
		...
		switch($step) {
			...
			case '5'://安装进度
				...
				if (!@mysql_connect($tdb_host, $tdb_user, $tdb_pass)) dexit('无法连接到数据库服务器，请检查配置');
			...
			case '6'://安装成功
				...
				$cache->set('install', 1);
				if ($data) file_put_contents(SITE_ROOT . './cache/install.lock', time());
				$this->view->assign(array(
				    'percent'  => '100%',
					'username' => $this->post('username'),
					'password' => $this->post('password'),
