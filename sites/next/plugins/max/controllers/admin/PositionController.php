...
class PositionController extends Admin {
    ...
    public function __construct() {
		parent::__construct();
		$this->position      = $this->plugin_model($this->namespace,'position');
		$this->position_data = $this->plugin_model($this->namespace,'position_data');
	}
	...
	public function indexAction() {
	    if ($this->post('submit')) {
			...
			$this->adminMsg($this->getCacheCode('position') . lang('success'), url($this->namespace . '/admin_position/index'), 3, 1, 1);
	    }
	...
	public function listAction() {
	    ...
	    if ($this->post('submit_order') && $this->post('form') == 'order') {
			...
			$this->adminMsg($this->getCacheCode('position') . lang('success'), url($this->namespace . '/admin_position/list/', array('posid' => $posid)), 3, 1, 1);
	    }
