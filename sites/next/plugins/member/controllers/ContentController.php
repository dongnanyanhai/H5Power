...
class ContentController extends Plugin {
	...
	public function indexAction() {
		...
		//投稿权限验证
		if ($this->memberPost($this->cmodel[$modelid]['setting']['auth'])) $this->memberMsg(lang('m-con-12'));
	...
	public function addAction() {
		...
		$modelid = (int)$this->get('modelid');
	    if (empty($modelid) && $catid) $modelid = $this->cats[$catid]['modelid'];
