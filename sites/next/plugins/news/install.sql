...
({menuid}, 1, '内容管理', '{namespace}/admin_category/index', '{selectid2}', '{namespace}', 1);
...
({selectid}, 1, {menuid}, 0, '', 1, '', 1, 0, '栏目模型', '#', '#', '{namespace}', '', 0),
({selectid2}, 1, {menuid}, {selectid}, '', 0, '', 1, 0, '栏目管理', '{namespace}/admin_category/index', '', '{namespace}', '', 1),
(null, 1, {menuid}, {selectid}, '', 0, '', 1, 0, '附件管理', '{namespace}/admin_attachment/index', '', '{namespace}', '', 2),
(null, 1, {menuid}, {selectid}, '', 0, '', 1, 0, '内容模型', '{namespace}/admin_model/index', '', '{namespace}', '', 4),
(null, 1, {menuid}, {selectid}, '', 0, '', 1, 0, '表单模型', '{namespace}/admin_model/index', '&amp;typeid=3', '{namespace}', '', 5),
(null, 1, {menuid}, 0, '', 0, '', 1, 0, '内容管理', '#', '#', '{namespace}', '', 0),
(null, 1, {menuid}, 0, '', 0, '', 1, 0, '表单管理', '#', '#', '{namespace}', '', 0),
(null, 1, {menuid}, {selectid}, '', 0, '', 1, 0, '菜单模型', '{namespace}/admin_model/index', '&amp;typeid=5', '{namespace}', '', 3);